...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        // Default is 12MB — too small for video uploads. Widened to 50MB;
        // each upload type still enforces its own stricter rule on top of
        // this (images stay capped at 5MB via PostCreate/PostEdit's own
        // validation, this just controls what even reaches that stage).
