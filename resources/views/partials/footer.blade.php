...
<footer class="bg-[#0d1b4b] text-white mt-16">
    ...
    <div class="container mx-auto max-w-7xl px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-[1fr_auto_auto] gap-10">
            ...
            <div class="max-w-xs">
                ...
                <p class="text-sm text-white/50 leading-relaxed">
                    {{ __('Your trusted source for breaking news, in-depth analysis and stories that matter — across politics, sports, culture, science, opinion and the world.') }}
                </p>
                <div class="flex items-center gap-3 mt-5">
                    {{-- Twitter / X --}}
                    <a href="#" aria-label="{{ __('Follow on X') }}"
                    ...
                    {{-- Facebook --}}
                    <a href="#" aria-label="{{ __('Follow on Facebook') }}"
                       class="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center
                              text-white/50 hover:text-white hover:border-white/50 transition-colors">
                        <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {{-- YouTube --}}
                    <a href="#" aria-label="{{ __('Watch on YouTube') }}"
                       class="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center
                              text-white/50 hover:text-white hover:border-white/50 transition-colors">
                        <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="w-full md:w-64">
                ...
                <p class="text-sm text-white/50 mb-3">{{ __('Top stories, once a week.') }}</p>
                <livewire:marketing.newsletter-subscribe/>
            </div>
    ...
    <div class="border-t border-white/10">
        <div class="container mx-auto max-w-7xl px-4 py-4
            ...
            <div class="flex items-center gap-4">
                <a href="{{ route('feed') }}" class="hover:text-white/60 transition-colors">{{ __('RSS') }}</a>
                <a href="{{ route('sitemap') }}" class="hover:text-white/60 transition-colors">{{ __('Sitemap') }}</a>
                <a href="#" class="hover:text-white/60 transition-colors">{{ __('Privacy Policy') }}</a>
                <a href="#" class="hover:text-white/60 transition-colors">{{ __('Terms of Use') }}</a>
                <a href="#" class="hover:text-white/60 transition-colors">{{ __('Contact') }}</a>
            </div>
        </div>
    </div>
</footer>
